...
export default class Toolbar extends React.Component {
  ...
  exportSceneToIPFS () {
    ga('send', 'event', 'SceneGraph', 'exportGLTF');
    INSPECTOR.exporters.gltf.parse(AFRAME.scenes[0].object3D, function (result) {
      var ipfs = window.IpfsApi(); //source does not webpack well, include in head: https://unpkg.com/ipfs-api/dist/index.js
      var output = JSON.stringify(result, null, 2);
      ipfs = IpfsApi('localhost', '5001'); //Configure CORS
      const buf = window.buffer.Buffer(output); //script source, include in head: https://wzrd.in/standalone/buffer
